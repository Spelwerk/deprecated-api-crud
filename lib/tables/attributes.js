...
module.exports.post = function(user, name, description, icon, typeId, avatar, creature, optional, minimum, maximum, callback) {
    ...
    async.series([
        function(callback) {
            query('INSERT INTO attribute (user_id,name,description,icon,attributetype_id,avatar,creature,optional,minimum,maximum) VALUES (?,?,?,?,?,?,?,?,?,?)', [user.id, name, description, icon, typeId, avatar, creature, optional, minimum, maximum], function(err, result) {
