...
module.exports.put = function(user, id, name, description, typeId, legal, price, damageDice, damageBonus, criticalDice, criticalBonus, distance, corporationId, callback) {
    if(!user.id) return callback({status: 403, message: 'Forbidden', error: 'User is not logged in'});
