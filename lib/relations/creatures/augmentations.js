...
async function insert(req, res, next, creatureId, bionicId) {
    ...
    try {
        ...
        let query = 'INSERT INTO creature_has_augmentation (creature_id,bionic_id,augmentation_id) VALUES (?,?,?) ON DUPLICATE KEY UPDATE augmentation_id = VALUES(augmentation_id)';
