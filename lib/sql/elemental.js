...
module.exports.post = function(user, body, tableName, options, callback) {
    ...
    if(schema.adminRestriction && !user.admin) return callback(new UserNotAdministratorError);
    ...
    async.series([
        ...
        function(callback) {
            if(!schema.userOwned) return callback();
...
module.exports.put = function(user, body, tableName, tableId, options, callback) {
    ...
    async.series([
        ...
        function(callback) {
            ...
            if(schema.updateField) sql += ' updated = CURRENT_TIMESTAMP,';
