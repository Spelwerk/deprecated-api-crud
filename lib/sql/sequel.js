...
exports.post = function(req, adminRequired, userSave, tableName, callback) {
...
exports.put = function(req, adminRequired, tableName, tableId, callback) {
    async.series([
        function(callback) {
            auth.ownership(req, adminRequired, tableName, tableId, callback);
        },
        function(callback) {
            var body        = req.body,
...
exports.clone = function(req, adminRequired, userSave, tableName, tableId, callback) {
...
exports.delete = function(req, adminRequired, tableName, tableId, callback) {
    async.series([
        function(callback) {
            auth.ownership(req, adminRequired, tableName, tableId, callback);
        },
