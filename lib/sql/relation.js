...
module.exports.value = function(req, res, next, genericId, relationId, relationValue) {
    var sql = 'UPDATE generic_has_generic SET value = ? WHERE generic_id = ? AND relation_id = ?',
...
module.exports.custom = function(req, res, next, genericId, relationId, relationCustom) {
    var sql = 'UPDATE generic_has_generic SET custom = ? WHERE generic_id = ? AND relation_id = ?',
