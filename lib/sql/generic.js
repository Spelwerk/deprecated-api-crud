...
module.exports.put = function(req, res, next, tableName, tableId) {
    ...
    async.series([
        function(callback) {
            ownership(req, tableId, callback);
        },
        function(callback) {
...
module.exports.canon = function(req, res, next, tableId, canon) {
    ...
    query('UPDATE generic SET canon = ?, updated = CURRENT_TIMESTAMP WHERE id = ?', [canon, tableId], function(err) {
        if(err) return next(err);
...
module.exports.revive = function(req, res, next, tableId) {
    ...
    query('UPDATE generic SET deleted = NULL WHERE id = ?', [tableId], function(err) {
        if(err) return next(err);
