...
const uniques = require('../database/uniques');
...
function permission(router, tableName) {
    router.route('/:id/permissions')
        .get(async (req, res, next) => {
            try {
                let data = await permissions.get(req, tableName, req.params.id);
        ...
        .post(async (req, res, next) => {
            try {
                await permissions.keep(req, tableName, req.params.id);
    ...
    router.route('/:id/permissions/favorite/:boolean')
        .put(async (req, res, next) => {
            try {
                await permissions.favorite(req, tableName, req.params.id, req.params.boolean);
    ...
    router.route('/:id/permissions/user/:user/edit/:boolean')
        .put(async (req, res, next) => {
            try {
                await permissions.edit(req, tableName, req.params.id, req.params.user, req.params.boolean);
