...
async function insert(req, res, next, tableName, tableId, relationName, relationId, ignoredFields) {
    try {
        await relations.insert(req.user, req.body, tableName, tableId, relationName, relationId, ignoredFields);
...
async function update(req, res, next, tableName, tableId, relationName, relationId, ignoredFields) {
    try {
        await relations.update(req.user, req.body, tableName, tableId, relationName, relationId, ignoredFields);
...
async function remove(req, res, next, tableName, tableId, relationName, relationId) {
    try {
        await relations.remove(req.user, tableName, tableId, relationName, relationId);
