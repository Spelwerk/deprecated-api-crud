...
async function insert(user, body, tableName, tableId, relationName, relationId, ignoredFields) {
...
async function update(user, body, tableName, tableId, relationName, relationId, ignoredFields) {
    tableId = parseInt(tableId);
    relationId = parseInt(relationId);
    ignoredFields = ignoredFields || [];
...
async function remove(user, tableName, tableId, relationName, relationId) {
    tableId = parseInt(tableId);
    relationId = parseInt(relationId);
