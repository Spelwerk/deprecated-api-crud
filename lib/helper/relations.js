...
module.exports = function(router, tableName, routeName, relationName) {
    ...
    router.route('/:id/' + routeName)
        ...
        .post(function(req, res, next) {
            relation.post(req, res, next, tableName, req.params.id, relationName, req.body.insert_id);
        });
    ...
    router.route('/:id/' + routeName + '/:itemId')
        ...
        .put(function(req, res, next) {
            relation.put(req, res, next, tableName, req.params.id, relationName, req.params.itemId);
        })
        .delete(function(req, res, next) {
            relation.delete(req, res, next, tableName, req.params.id, relationName, req.params.itemId);
        });
};
