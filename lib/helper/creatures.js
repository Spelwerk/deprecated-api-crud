...
let AppError = require('../errors/app-error'),
    DatabaseRowNotFoundError = require('../errors/database-row-not-found-error'),
    UserNotLoggedInError = require('../errors/user-not-logged-in-error');

let async = require('async'),
    yaml = require('node-yaml').readSync;
...
// CREATURE HELPER
let additive = require('../creatures/additive'),
    augmentation = require('../creatures/augmentation'),
    bionic = require('../creatures/bionic'),
    equipment = require('../creatures/equipment'),
    exclusive = require('../creatures/exclusive'),
    points = require('../creatures/points'),
    value = require('../creatures/value');
