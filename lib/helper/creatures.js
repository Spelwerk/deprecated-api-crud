    ...
    router.route('/:id/backgrounds')
        ...
        .post(function(req, res, next) {
            ...
            async.series([
                ...
                function(callback) {
                    query('INSERT INTO creature_has_' + table + ' (creature_id,' + table + '_id) VALUES (?,?)', [creatureId, backgroundId], callback);
                },
                function(callback) {
    ...
    router.route('/:id/bionics')
        ...
        .post(function(req, res, next) {
            async.series([
                ...
                function(callback) {
                    value.add(req.user, req.params.id, table, req.body.insert_id, {ignoreArray: ['augmentation', 'software']}, callback);
                }
            ], function(err) {
                if(err) return next(err);
    ...
    router.route('/:id/bionics/:itemId')
        ...
        .delete(function(req, res, next) {
            ...
            async.series([
                ...
                function(callback) {
                    query('DELETE FROM creature_has_bionic WHERE creature_id = ? AND bionic_id = ?', [creatureId, bionicId], callback);
                }
            ], function(err) {
                if(err) return next(err);
...
module.exports.loyalties = function(router) {
    ...
    router.route('/:id/loyalties/:uqId/create')
        .post(function(req, res, next) {
            ...
            let creature = {firstname: null, lastname: null, creaturetype_id: null, species_id: speciesId, wealth_id: null, occupation: null},
                relation = {creature_id: creatureId, relation_id: null, loyalty_id: null, milestone_id: null};
