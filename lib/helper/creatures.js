    ...
    router.route('/:id/backgrounds')
        ...
        .post(function(req, res, next) {
            async.series([
                ...
                function(callback) {
                    value.add(req.user, req.params.id, table, req.body.insert_id, {ignoreArray: ['bionic', 'weapon']}, callback);
                },
                function(callback) {
    ...
    router.route('/:id/backgrounds/:itemId')
        ...
        .delete(function(req, res, next) {
            async.series([
                ...
                function(callback) {
                    value.subtract(req.user, req.params.id, table, req.params.itemId, {ignoreArray: ['bionic', 'weapon']}, callback);
                },
                function(callback) {
...
module.exports.milestones = function(router) {
    ...
    router.route('/:id/milestones')
        ...
        .post(function(req, res, next) {
            ...
            async.series([
                ...
                function(callback) {
                    value.add(req.user, creatureId, table, milestoneId, {ignoreArray: ['bionic', 'loyalty', 'weapon']}, callback);
                },
                function(callback) {
                    bionic.add(req.user, req.params.id, table, req.body.insert_id, callback);
                },
    ...
    router.route('/:id/milestones/:itemId')
        ...
        .delete(function(req, res, next) {
            removeRelationWithValues(req.user, req.params.id, table, req.params.itemId, {ignoreArray: ['bionic', 'loyalty']}, function(err) {
                if(err) return next(err);
...
module.exports.protection = function(router) {
    ...
    router.route('/:id/protection/:itemId/equip')
        .put(function(req, res, next) {
            equipment.equip(req.user, req.params.id, table, req.params.itemId, null, function(err) {
                if(err) return next(err);
    ...
    router.route('/:id/protection/:itemId/unequip')
        .put(function(req, res, next) {
            equipment.unequip(req.user, req.params.id, table, req.params.itemId, null, function(err) {
                if(err) return next(err);
