...
let augmentation = require('../creatures/augmentation'),
    ...
    weapon = require('../creatures/weapon');
...
function post(user, firstName, worldId, speciesId, optional, callback) {
    ...
    async.series([
        ...
        function(callback) {
            weapon.addCombination(user, id, 'species', speciesId, callback);
        },
        function(callback) {
    ...
    router.route('/:id/backgrounds')
        ...
        .post(function(req, res, next) {
            async.series([
                ...
                function(callback) {
                    value.add(req.user, req.params.id, table, req.body.insert_id, {ignoreArray: ['armour', 'bionic', 'weapon']}, callback);
                },
                function(callback) {
                    bionic.add(req.user, req.params.id, table, req.body.insert_id, callback);
                },
                function(callback) {
                    weapon.addRelation(req.user, req.params.id, table, req.body.insert_id, callback);
                }
            ], function(err) {
                if(err) return next(err);
    ...
    router.route('/:id/backgrounds/:itemId')
        ...
        .delete(function(req, res, next) {
            async.series([
                ...
                function(callback) {
                    value.subtract(req.user, req.params.id, table, req.params.itemId, {ignoreArray: ['armour', 'bionic', 'weapon']}, callback);
                },
                function(callback) {
    ...
    router.route('/:id/manifestations')
        ...
        .post(function(req, res, next) {
            ...
            async.series([
                ...
                function(callback) {
                    weapon.addCombination(req.user, creatureId, 'manifestation', manifestationId, callback);
                }
            ], function(err) {
                if(err) return next(err);
    ...
    router.route('/:id/manifestations/:itemId')
        ...
        .delete(function(req, res, next) {
            ...
            async.series([
                ...
                function(callback) {
                    weapon.removeCombination(req.user, creatureId, 'manifestation', manifestationId, callback);
                }
            ], function(err) {
                if(err) return next(err);
...
module.exports.milestones = function(router) {
    ...
    router.route('/:id/milestones')
        ...
        .post(function(req, res, next) {
            ...
            async.series([
                ...
                function(callback) {
                    value.add(req.user, creatureId, table, milestoneId, {ignoreArray: ['armour', 'bionic', 'loyalty', 'weapon']}, callback);
                },
                function(callback) {
                    bionic.add(req.user, req.params.id, table, req.body.insert_id, callback);
                },
    ...
    router.route('/:id/milestones/:itemId')
        ...
        .delete(function(req, res, next) {
            removeRelationWithValues(req.user, req.params.id, table, req.params.itemId, {ignoreArray: ['armour', 'bionic', 'loyalty', 'weapon']}, function(err) {
                if(err) return next(err);
