...
module.exports.root = function(router, sql, tableName, adminRestriction, userOwned) {
    router.route('/')
        ...
        .post(function(req, res, next) {
            sequel.post(req, res, next, tableName, adminRestriction, userOwned);
        });
...
module.exports.id = function(router, sql, tableName, adminRestriction, userOwned) {
    router.route('/:id')
        .get(function(req, res, next) {
        ...
        .put(function(req, res, next) {
            sequel.put(req, res, next, tableName, req.params.id, adminRestriction, userOwned, true);
        })
...
module.exports.clone = function(router, tableName) {
    router.route('/:id/clone')
        .post(function(req, res, next) {
            ...
            //todo when clone function is done, remove this
...
module.exports.ownership = function(router, tableName) {
    router.route('/:id/ownership')
        .get(function(req, res) {
            ownership(req.user, tableName, req.params.id, function(err) {
                var ownership = true;
...
//todo admin only: give ownership of user_id to other user_id
module.exports.own = function(router, tableName) {
    router.route('/:id/own/:userId')
        .put(function(req, res, next) {
